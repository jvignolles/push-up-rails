...
SimpleForm.setup do |config|
  ...
  config.wrappers :append, :tag => 'div', :class => "form-group", :error_class => 'has-error has-feedback' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
    b.wrapper :tag => 'div', :class => CUSTOM_INPUT_CLASS do |input|
  ...
  config.wrappers :checkbox, :tag => 'div', :class => 'form-group', :error_class => 'has-error has-feedback' do |b|
  ...
  config.wrappers :inline_checkbox, :tag => 'div', :class => 'form-group', :error_class => 'has-error has-feedback' do |b|
    b.wrapper :tag => 'div', :class => CUSTOM_INPUT_CLASS + ["form-field-label"] do |ba|
      ba.use :label_input
      ba.use :feedback
    end
  ...
  config.wrappers :inline_checkbox_ori, :error_class => 'has-error has-feedback' do |b|
